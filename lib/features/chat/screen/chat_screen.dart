                    ...
                    child: Padding(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: state.trainersModel.result![index].imageUrl==null?
                          DecorationImage(
                            image:
                          ...
                          DecorationImage(
                              image: NetworkImage(
                                state.trainersModel.result![index].imageUrl ?? "",
                              ),
                              fit: BoxFit.cover),
                        ),
                        child: Column(
      ...
      builder: (context, snapshot) {
        if (snapshot.connectionState == ConnectionState.none) {
          ...
          for (var element in snapshot.data!.docs){
            if(element.data()["traineeId"] == BlocProvider.of<ProfileCubit>(context).profileModel!.result!.id){
                              ...
                              Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      StreamBuilder
                                        (
                                        stream: FirebaseFirestore.instance.collection('chats').doc(BlocProvider.of<ProfileCubit>(context).profileModel!.result!.id.toString() + chats[index].trainerId.toString()).collection("messages").orderBy("messageTime",descending: true).snapshots(),
                                        builder: (context, snapshot) {
